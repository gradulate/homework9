/**
 * Created by lena on 29.03.15.
 */
/* функція бере два класси, і робить один потомком іншого
 1-й спосіб наслідування*/
...
var blue = new Mario_Blue('Синій', 1, 10);
var red = new Mario_Red('Червоний');
